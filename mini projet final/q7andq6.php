...
if (!$xml->schemaValidate('Q6.xsd')) {
    print '<b>DOMDocument::schemaValidate() Generated Errors!</b>';
    libxml_display_errors();
}else {
echo "<script>alert('le fichier xml fileQ7.xml  est valide par Q6.xsd' )</script>"; 

echo "<h1>le fichier xml fileQ7.xml  est valide par Q6.xsd</h1>"; 
}
